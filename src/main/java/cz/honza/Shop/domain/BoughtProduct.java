...
public class BoughtProduct {
    // id is not needed, two foreign keys
    ...
    public BoughtProduct(int productId, int customerId, int quantity) { //timestamp will be generated
        this.productId = productId;
        this.customerId = customerId;
        this.quantity = quantity;
        this.boughtAt = Timestamp.from(Instant.now()); // new time in time of constructor call
    }
